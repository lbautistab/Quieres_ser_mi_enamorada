...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Gracias mi Silvia! <br> El hecho de que estés dispuesta a darme una oportunidad me llena de gratitud y emoción. <br> Prometo cuidarte, respetarte y amarte con todo mi ser.  <br> Eres la persona que hace que mi mundo sea más hermoso, <br> y me encantaría tener la oportunidad de hacer lo mismo por ti. <br> !Feliz primer día de enamorados!';
